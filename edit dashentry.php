...
<body>
    ...
    <form method="post">
        <br> <br> <br>
    <label style=" margin-left:20px; color:#8C8C8C; " for="test-name">Test Name</label>
    <br>
    ...
    error_reporting(1);
     if(isset($_POST['submit']))
     {
               ...
               if(empty($description)){
                ...
                $query="UPDATE `dashboard` SET `testname`='$tn',`heading`='$heading',`description`='$description' WHERE `id`='$id'";
