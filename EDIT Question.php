...
<?php
     if(isset($_GET['update'])){
         ...
         $pn=$_GET['phoneNo'];
         $pass=$_GET['password'];
 $query1="UPDATE `user` SET `uniqueno`='$uni',`s.no`='$sno',`first_name`='$firstname',`last_name`='$lastname',`username`='$username',`class`='$class',`schoolname`='$sn', `phoneNo`='$pn',`email`='$email',`password`='$pass' WHERE `s.no`='$sno' ";
